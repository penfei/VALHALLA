...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 33555162;
      var PACKAGE_UUID = '2c247f58-dc45-4968-8c07-3e30374f2d5c';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 29042753, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(29042753, 29049156, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(29049156, 29049177, 0, 0).open('GET', '/PlayerConnectionConfigFile');
    new DataRequest(29049177, 29061681, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(29061681, 32652565, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(32652565, 33527537, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(33527537, 33555162, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
